    ...
    public class ConcertDataContext : DbContext
    {
        ...
        public void Initialize()
        {
            ...
            var artists = new[] {
                ...
                new { Name = "Margarida Gouveia", Genre = "Rock", Tour = "Rainy Renegades", Description = "The Rainy City Renegades are a fictional Seattle rock duo formed in Belleview in 2013. The band's sound is rooted in modern blues, alternative metal, hip-hop, and 70's influences. Their first album Royal Blueberries was released in August 2014." },
            ...
            var locations = new[] { "Belleview Field, Seattle, USA", "Quebeck Stadium, Montreal, Canada", "Queenslund Stage, Brizbane, Australia", "Overground Stadium, London, England", "The Chocolate Dome, Brussels, Belgium", "Central Town Theater, Cape Town, South Africa", "Metal Fields, Rome, Italy", "Train Ampitheatre, Tokyo, Japan" };
